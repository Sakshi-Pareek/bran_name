    ...
    <>
      <div className="bg-[#2D4059]">
        <div className="max-w-[1334px] px-3 mx-auto xl:py-40 lg:py-24 md:py-16 py-10">
          ...
          <h4
            className="text-[24px] font-bold text-center text-white leading-[134%] tracking-[0.1px] my-2.5"
            data-aos="zoom-in"
            data-aos-duration="1000"
            data-aos-easing="linear"
          >
          ...
          <p
            className="text-white text-[14px] font-normal text-center leading-[143%] tracking-[0.2px] max-w-[469px] mx-auto xl:mb-20 lg:mb-10 md:mb-7 mb-5"
            data-aos="zoom-in"
            data-aos-duration="1000"
            data-aos-easing="linear"
          >

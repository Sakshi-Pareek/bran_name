    ...
    <>
      <div className="max-w-[1334px] px-3 mx-auto xl:py-40 lg:py-24 md:py-16 py-10 xl:mb-[61px]">
        ...
        <div className="flex flex-row flex-wrap max-w-[688px] mx-auto justify-between gap-7">
          <div className="sm:w-[47.7%] w-full" data-aos="fade-right"
          data-aos-duration="1000"
          data-aos-easing="linear">
            <div className="lg:py-[35px] lg:px-[40px] p-5 gap-5 shadow-[0px_13px_19px_0px_rgba(0,_0,_0,_0.07)] flex flex-col justify-center items-center hover:scale-[1.01] transition-all duration-300 ease-linear cursor-pointer">
              <PCIcon />
          ...
          <div className="sm:w-[47.7%] w-full"data-aos="fade-left"
          data-aos-duration="1000"
          data-aos-easing="linear">
            <div className="lg:py-[35px] lg:px-[40px] p-5 gap-5 shadow-[0px_13px_19px_0px_rgba(0,_0,_0,_0.07)] flex flex-col justify-center items-center hover:scale-[1.01] transition-all duration-300 ease-linear cursor-pointer">
              <PencileIcon />
